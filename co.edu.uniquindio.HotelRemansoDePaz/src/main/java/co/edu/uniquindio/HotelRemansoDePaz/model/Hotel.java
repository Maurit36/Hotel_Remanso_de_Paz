...
import co.edu.uniquindio.HotelRemansoDePaz.constantes.TamanoMatriz;
import co.edu.uniquindio.HotelRemansoDePaz.enums.*;
import co.edu.uniquindio.HotelRemansoDePaz.service.ServicioDeHabitacion;
...
public class Hotel extends ServicioDeHabitacion {
    ...
    private Cliente crearCliente(String nombre, String dni) throws Exception {
    ...
    public Reserva crearReserva(String nombre,
                                String dni,
